<?php
	...
	//inserte la función definida por el usuario aquí
	// TODO - dynamic query
	function getNumRowsQuery($query) {  //obtener consulta de número de filas
	...
	function getFetchAssocQuery($query) { //Obtener consulta de asociación
		global $sqlconnection;
		if ($result = $sqlconnection->query($query)) {
			...
			echo "Algo anda mal la consulta!";
			echo $sqlconnection->error;
	}

	function getLastID($id,$table) { //obtener la última identificación
		global $sqlconnection;
	...
	function getCountID($idnum,$id,$table) { //obtener ID de recuento
		global $sqlconnection;
