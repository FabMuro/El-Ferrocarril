      ...
      <ul class="sidebar navbar-nav">       
        <?php
         ...
         if ($_SESSION['user_role'] == "Cajero") {
          echo '
          <li class="nav-item">
            <a class="nav-link" href="../admin/caja.php">
         ...
         '; 
          ...
          if ($_SESSION['user_role'] == "Almacenero") {
            echo '
            <li class="nav-item">
              <a class="nav-link" href="../admin/almacen.php">
                <i class="fas fa-fw fa-utensils"></i>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Sistema de Restaurante El Ferrocarril - CICLO 2020-II - TPI</span>
            </div>
          </div>
        </footer>
