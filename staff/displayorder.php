...
<?php
	...
	//mostrar la lista de pedidos actual para la gestión de la cocina
		...
		$displayOrderQuery =  "
			...
			if ($orderResult = $sqlconnection->query($displayOrderQuery)) {
				...
				if ($orderResult->num_rows == 0) {
					...
					echo "<tr><td class='text-center' colspan='7' >Sin pedido por ahora :)</td></tr>";
				}
	...
	//mostrar la lista actual de pedidos listos en el índice de personal
