...
<html lang="en">
  ...
  <head>
    ...
    <title>Menu - Config. Web Admin</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <!--<a class="navbar-brand mr-1" href="index.php">Restaurante | Ferrocarril</a>-->
      <a class="navbar-brand mr-1" href="menu.php">Restaurante | Ferrocarril</a>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <!--<a href="index.php">Panel de Control</a> Mostrar Panel de Control / Productos--> 
          ...
          <hr>
          <p>Acá puedes gestionar las categorias y productos del  restaurante, puedes agregar categorías, agregar productos y modificarlos. </p>
            	...
            	<?php 
					...
					if ($menuResult = $sqlconnection->query($menuQuery)) {
						...
						while($menuRow = $menuResult->fetch_array(MYSQLI_ASSOC)) {?>
							...
							<?php
								//$menuItemQuery = "SELECT * FROM tbl_menuitem WHERE disponible = 1 and menuID = " . $menuRow["menuID"] ;
								...
								if ($menuItemResult = $sqlconnection->query($menuItemQuery)) {
									...
									if ($menuItemResult->num_rows == 0) {
											echo "<td colspan='5' class='text-center'>Sin productos agregados en esta Categoría</td>";
										}
									...
									while($menuItemRow = $menuItemResult->fetch_array(MYSQLI_ASSOC)) {	?>
										...
										<tr>
			        						...
			        						<td><?php echo $menuItemRow["precioOferta"] ?></td>
			        						<td>
			        							<a href="#editItemModal" data-toggle="modal" data-itemname="<?php echo $menuItemRow["menuItemName"] ?>" data-itemprice="<?php echo $menuItemRow["price"] ?>" data-itemprecioOferta="<?php echo $menuItemRow["precioOferta"] ?>"data-menuid="<?php echo $menuRow["menuID"] ?>" data-itemid="<?php echo $menuItemRow["itemID"] ?>">Editar </a>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Sistema de Restaurante El Ferrocarril Ciclo 2020 II - Curso TPI</span>
            </div>
          </div>
        </footer>
	...
	<div class="modal fade" id="addMenuModal" tabindex="-1" role="dialog" aria-labelledby="addMenuModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="addMenuModalLabel">Agregar Nueva Categoría</h5>
	      ...
	      <div class="modal-body">
	        <form id="addmenuform" method="POST">
	        	<div class="form-group">
		            ...
		            <input type="text" required="required" class="form-control" name="menuname" placeholder="Puedes agregar categorias como postres, bebidas, etc...." >
		        </div>
	        </form>
	      </div>
	      <div class="modal-footer">
	      ...
	      <div class="modal-body">
	        <form id="additemform" method="POST">
	        	<div class="form-group">
		            ...
		            <input type="text" required="required" class="form-control" name="itemName" placeholder="Escribir el nombre del producto aqui" >
		        </div>
		        <div class="form-group">
		            <label class="col-form-label">Precio (S/.):</label>
		            <input type="text" required="required" class="form-control" name="itemPrice"  >
		            <input type="hidden" name="menuID" id="menuid">
		        </div>
		        <div class="form-group">
		            <label class="col-form-label">P. Oferta (S/.):</label>
		            <input type="text" required="required" class="form-control" name="itemprecioOferta"  >
		            <input type="hidden" name="menuID" id="menuid">
		        </div>
	        </form>
	      </div>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="edititemform" action="edititem.php" method="POST">
	        	<div class="form-group">
		            <label class="col-form-label">Nombre:</label>
		            <input type="text" required="required" id="itemname" class="form-control" name="itemName" placeholder="" >
		        </div>
		        <div class="form-group">
		            <label class="col-form-label">Precio (S/.):</label>
		        ...
		        <div class="form-group">
		            <label class="col-form-label">P. Oferta (S/.):</label>
		            <input type="text"  id="itempreciooferta" class="form-control" name="itemprecioOferta" placeholder="" >
		            <input type="hidden" name="menuID" id="menuid">
		            <input type="hidden" name="itemID" id="itemid">
		        </div>
	        </form>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" form="edititemform" class="btn btn-primary" name="btnedit">Guardar</button>
	      </div>
	    </div>
	  </div>
	</div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Seleccione "Eliminar" a continuación se eliminará <strong>todos</strong> su Produto en esta categoría.</div>
          <div class="modal-footer">
    ...
    <script>
    	...
    	$('#addItemModal').on('show.bs.modal', function (event) {
			  ...
			  var modal = $(this);
			  modal.find('.modal-title').text('Agregar Nuevo Producto en:  ' + category );
		...
		$('#editItemModal').on('show.bs.modal', function (event) {
			  ...
			  var itempreciooferta = button.data('itempreciooferta');
			  ...
			  modal.find('.modal-body #itempreciooferta').val(itempreciooferta);
		});
