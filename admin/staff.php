                          ...
                          ?>  
                              ...
                              <td>
                                ...
                                <noscript><input type="submit" value="Enviar"></noscript>
                                 ...
                                 <a href="deletestaff.php?staffID=<?php echo $staff['staffID']; ?>" class="btn btn-sm btn-danger">Eliminar</a>

                                 <a href="deletestaff.php?staffID=<?php echo $staff['staffID']; ?>" class="btn btn-sm btn-danger">Modificar</a>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="addstaff.php" method="POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                    ...
                    <input type="text" required="required" name="staffname" class="form-control" placeholder="Ingrese Codigo" aria-label="Add" aria-describedby="basic-addon2">
                      <div class="input-group-append">
                        <button type="submit" name="addstaff" class="btn btn-primary">
                          <i>Buscar</i>
                        </button> 
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Sistema de Restaurante | Ferrocarril Ciclo 2020 I UNPRG</span>
            </div>
          </div>
        </footer>
